...
| Document | Purpose |
|----------|---------|
| [MCP_SETUP.md](MCP_SETUP.md) | Wire Cursor / Claude Code / Codex / remote agents to a Fractal backend via the `fractal-mcp` MCP server (local stdio + remote HTTP) |
...
| [AI_INTEGRATION_DESIGN.md](AI_INTEGRATION_DESIGN.md) | How external AI agents (P4) and autonomous strategy AIs (P5) consume Fractal via a versioned, scoped Agent Gateway |
