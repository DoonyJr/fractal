...
def _build_html_report(
    ...
    texts = {
        ...
        'subtitle': '由 Fractal AI 快速分析引擎生成' if is_zh else 'Generated by Fractal Fast AI Analysis Engine',
...
def _build_telegram_report(
    ...
    lines.extend([
        ...
        f"<i>{'由 Fractal 多智能体系统生成' if is_zh else 'Generated by Fractal Multi-Agent System'}</i>",
    ])
