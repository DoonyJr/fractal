...
def test_transport_default_is_stdio(monkeypatch, fresh_module):
    monkeypatch.delenv("FRACTAL_MCP_TRANSPORT", raising=False)
...
def test_apply_http_settings_without_error(monkeypatch, fresh_module):
    ...
    monkeypatch.setenv("FRACTAL_MCP_HOST", "0.0.0.0")
    monkeypatch.setenv("FRACTAL_MCP_PORT", "7777")
